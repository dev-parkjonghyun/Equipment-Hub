...
function renderScenePane() {
    ...
    h += `<div class="pane-btns">
          ...
          <div class="slot-help" style="margin-bottom:8px">
            ${isLoggedIn()
              ? '작업 내용이 이 브라우저와 <b>서버에 함께 저장</b>돼, 다른 기기에서도 이어서 작업할 수 있습니다.<br>파일로도 받아두면 더 안전합니다.'
              : '작업 내용은 <b>이 브라우저에만</b> 저장됩니다. <b>로그인하면 서버에 저장</b>돼 다른 기기에서도 이어집니다.<br>또는 실수로 지워질 경우에 대비해 파일로 받아두세요.'}
          </div>
          <div class="pane-btns">
